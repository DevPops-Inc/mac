...
get_terminal_app() {
    if [ -z $terminalApp ]; then 
        read -p "Please type the terminal application you would like to check and press \"return\" key (Example: pip): " terminalApp
...
check_parameters() {
    ...
    if [ $valid == "true" ]; then 
        ...
        tput setaf 1; echo "One or more parameter checks passed."; tput sgr0
